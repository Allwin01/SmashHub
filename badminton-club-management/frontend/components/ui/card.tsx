...
// components/ui/card.tsx
import * as React from "react";
import { cn } from "@/lib/utils"; // Ensure this exists or replace with your class join function

const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("rounded-xl border bg-white p-6 shadow", className)} {...props} />
  )
);
Card.displayName = "Card";
