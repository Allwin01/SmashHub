...
import ParentAccess from '@/components/UserAccess/ParentAccess';
import MemberAccess from '@/components/UserAccess/MemberAccess';
import AdminAccess from '@/components/UserAccess/AdminAccess';
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="parent" className="w-full">
        ...
        <TabsContent value="parent">
          <ParentAccess showName={true} formatName={(player) => `${player.firstName} ${player.surName}`} />
        </TabsContent>

        <TabsContent value="member">
          <MemberAccess showName={true} formatName={(player) => `${player.firstName} ${player.surName}`} />
        </TabsContent>
