...
const playersData: Player[] = [
  { id: 'p1', name: 'Allwin', gender: 'Male' },
  { id: 'p2', name: 'Selina', gender: 'Female' },
  { id: 'p3', name: 'Jovan', gender: 'Male' },
  { id: 'p4', name: 'Rathi', gender: 'Female' },
  { id: 'p5', name: 'Mark', gender: 'Male' },
  { id: 'p6', name: 'Sophie', gender: 'Female' },
  { id: 'p7', name: 'Raj', gender: 'Male' },
  { id: 'p8', name: 'Emily', gender: 'Female' }
];
...
function SortablePlayer({ id, name, gender }: Player) {
  ...
  const gradient = gender === 'Male' ? 'from-blue-400 to-cyan-400' : 'from-pink-400 to-purple-400';
