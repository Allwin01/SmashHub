          ...
          >
            ...
            {/*
              <div className="flex items-center justify-between text-sm text-white">
                ...
                <button type="button" className="text-white underline hover:text-yellow-200">
              ...
              <div role="alert" aria-live="assertive" className="mt-4">
                <p className="flex items-center justify-center gap-2
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                       fill="currentColor" className="w-5 h-5 md:w-6 md:h-6">
        ...
        {showLogin && (
          <motion.div className="w-full max-w-sm sm:max-w-md md:max-w-lg bg-gradient-to-br from-yellow-300 via-pink-300 to-indigo-400/80 backdrop-blur-md shadow-2xl border border-white/20 p-8 sm:p-10 rounded-2xl" initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} transition={{ duration: 0.4 }}>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              <input type="text" placeholder="Email" value={email} onChange={(e) => setUsername(e.target.value)} autoFocus className="w-full px-5 py-4 text-lg sm:text-xl rounded-lg bg-white text-black placeholder-gray-500 focus:outline-none" required />
